...
I will make a sequence to represent the students and their birthdays that Brownlow made bets with, to get the statistics if any of them shared their birthday. 
...
I will first make A sequence on numbers from 1-365 to represent all the possible birthdays the students have. Then I will make another sequence of 35 to represent and use that as a sample from the 365. 
